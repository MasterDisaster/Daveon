...
public class DaveonSearcher
{
	 ...
	 *
	 * @return null - je�li wyst�pi� wyj�tek/b��d, String[0] je�li nie ma �adnych trafie�, String[] wynik�w je�li
	 *         s� jakie� trafienia. Ka�dy ze zwracanych String'�w ma format:
	 *         linkDoDokumentu//partsSeparator////begingTag//trafionyTekst//endTag//, gdzie //separator// gdzie
	 *         //partsSeparator//, //beginTag// oraz //endTag// to zmienne, okre�laj�ce w jaki spos�b ma by�
	 *         zwr�cony wynik.
	 * @author dmaciejewski
	 */
...
//				}});
			...
			//okresla index od ktorego b�d� zbierane informacje o wynikach - czyli elementy SearchElement
